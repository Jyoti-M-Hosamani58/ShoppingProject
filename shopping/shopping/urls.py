...
urlpatterns = [
    ...
    path('stffprintInvoice/<str:invoice_no>/', views.stffprintInvoice, name='stffprintInvoice'),
    ...
    path('staffsale',views.staffsale,name='staffsale'),
    path('staffsave_sales',views.staffsave_sales,name='staffsave_sales'),

    path('staffReturn',views.staffReturn,name='staffReturn'),
    path('staffsave_return',views.staffsave_return,name='staffsave_return'),
]
if settings.DEBUG:
